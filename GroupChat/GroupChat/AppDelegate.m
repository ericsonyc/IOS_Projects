...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //listViewController2.title = @"Contacts";
    //listViewController3.title = @"Groups";
    recordController.title=@"Records";
    
    
    NSArray *viewControllers = @[recordController];
...
//    tabBarController.selectedIndex = 1;
    ...
    tabBarController.selectedViewController = recordController;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "student.GroupChat" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"GroupChat" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"GroupChat.sqlite"];
    NSError *error = nil;
